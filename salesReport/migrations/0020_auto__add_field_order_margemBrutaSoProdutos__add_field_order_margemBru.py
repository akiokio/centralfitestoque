...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'order.margemBrutaSoProdutos'
        db.add_column(u'salesReport_order', 'margemBrutaSoProdutos',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'order.margemBrutaCartaoFrete'
        db.add_column(u'salesReport_order', 'margemBrutaCartaoFrete',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'order.margemBrutaSoProdutos'
        db.delete_column(u'salesReport_order', 'margemBrutaSoProdutos')

        # Deleting field 'order.margemBrutaCartaoFrete'
        db.delete_column(u'salesReport_order', 'margemBrutaCartaoFrete')
