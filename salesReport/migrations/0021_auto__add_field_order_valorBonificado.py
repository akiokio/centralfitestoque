...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'order.valorBonificado'
        db.add_column(u'salesReport_order', 'valorBonificado',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'order.valorBonificado'
        db.delete_column(u'salesReport_order', 'valorBonificado')
