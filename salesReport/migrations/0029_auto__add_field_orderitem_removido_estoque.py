...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'orderItem.removido_estoque'
        db.add_column(u'salesReport_orderitem', 'removido_estoque',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'orderItem.removido_estoque'
        db.delete_column(u'salesReport_orderitem', 'removido_estoque')
