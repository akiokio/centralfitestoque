...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'orderItem.is_child'
        db.add_column(u'salesReport_orderitem', 'is_child',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'orderItem.is_child'
        db.delete_column(u'salesReport_orderitem', 'is_child')
