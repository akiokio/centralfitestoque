...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'orderItem.quantidade'
        db.alter_column(u'salesReport_orderitem', 'quantidade', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'orderItem.quantidade'
        db.alter_column(u'salesReport_orderitem', 'quantidade', self.gf('django.db.models.fields.PositiveIntegerField')())
