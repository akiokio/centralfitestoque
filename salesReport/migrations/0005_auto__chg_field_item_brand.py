...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'item.brand'
        db.alter_column(u'salesReport_item', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['salesReport.brands'], null=True))

    def backwards(self, orm):

        # Changing field 'item.brand'
        db.alter_column(u'salesReport_item', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['salesReport.brands']))
