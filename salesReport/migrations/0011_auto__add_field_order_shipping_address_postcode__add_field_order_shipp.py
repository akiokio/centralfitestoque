...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'order.shipping_address_postcode'
        db.add_column(u'salesReport_order', 'shipping_address_postcode',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=500),
                      keep_default=False)

        # Adding field 'order.shipping_address_region'
        db.add_column(u'salesReport_order', 'shipping_address_region',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=500),
                      keep_default=False)

        # Adding field 'order.shipping_address_street'
        db.add_column(u'salesReport_order', 'shipping_address_street',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'order.shipping_address_postcode'
        db.delete_column(u'salesReport_order', 'shipping_address_postcode')

        # Deleting field 'order.shipping_address_region'
        db.delete_column(u'salesReport_order', 'shipping_address_region')

        # Deleting field 'order.shipping_address_street'
        db.delete_column(u'salesReport_order', 'shipping_address_street')
