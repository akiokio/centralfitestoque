...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'item.quantidade_faltante'
        db.alter_column(u'salesReport_item', 'quantidade_faltante', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'item.quantidade_faltante'
        db.alter_column(u'salesReport_item', 'quantidade_faltante', self.gf('django.db.models.fields.FloatField')(null=True))
