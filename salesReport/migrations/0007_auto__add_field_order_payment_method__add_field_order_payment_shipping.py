...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'salesReport_order', 'payment_method',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'order.payment_shipping_amount'
        db.add_column(u'salesReport_order', 'payment_shipping_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'order.payment_amount_ordered'
        db.add_column(u'salesReport_order', 'payment_amount_ordered',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'salesReport_order', 'payment_method')

        # Deleting field 'order.payment_shipping_amount'
        db.delete_column(u'salesReport_order', 'payment_shipping_amount')

        # Deleting field 'order.payment_amount_ordered'
        db.delete_column(u'salesReport_order', 'payment_amount_ordered')
    ...
    models = {
        ...
        u'salesReport.order': {
            ...
            'payment_amount_ordered': ('django.db.models.fields.FloatField', [], {}),
            'payment_method': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'payment_shipping_amount': ('django.db.models.fields.FloatField', [], {}),
