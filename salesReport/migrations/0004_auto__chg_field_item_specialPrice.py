...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'item.specialPrice'
        db.alter_column(u'salesReport_item', 'specialPrice', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'item.specialPrice'
        db.alter_column(u'salesReport_item', 'specialPrice', self.gf('django.db.models.fields.FloatField')(default=0))
