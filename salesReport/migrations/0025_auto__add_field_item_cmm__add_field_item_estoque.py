...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'item.cmm'
        db.add_column(u'salesReport_item', 'cmm',
    ...
    def backwards(self, orm):
        # Deleting field 'item.cmm'
        db.delete_column(u'salesReport_item', 'cmm')
    ...
    models = {
        ...
        u'salesReport.item': {
            ...
            'estoque': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
