...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'salesReport_order', 'shipping_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'order.discount_amount'
        db.add_column(u'salesReport_order', 'discount_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'salesReport_order', 'shipping_amount')

        # Deleting field 'order.discount_amount'
        db.delete_column(u'salesReport_order', 'discount_amount')
