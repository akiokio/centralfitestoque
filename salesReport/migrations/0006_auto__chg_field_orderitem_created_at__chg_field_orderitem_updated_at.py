...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'orderItem.created_at'
        db.alter_column(u'salesReport_orderitem', 'created_at', self.gf('django.db.models.fields.DateTimeField')(max_length=500, null=True))

        # Changing field 'orderItem.updated_at'
        db.alter_column(u'salesReport_orderitem', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'orderItem.created_at'
        db.alter_column(u'salesReport_orderitem', 'created_at', self.gf('django.db.models.fields.DateField')(max_length=500, null=True))

        # Changing field 'orderItem.updated_at'
        db.alter_column(u'salesReport_orderitem', 'updated_at', self.gf('django.db.models.fields.DateField')(max_length=500, null=True))
