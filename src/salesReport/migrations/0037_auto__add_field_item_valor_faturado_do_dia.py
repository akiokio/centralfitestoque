...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'item.valor_faturado_do_dia'
        db.add_column(u'salesReport_item', 'valor_faturado_do_dia',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'item.valor_faturado_do_dia'
        db.delete_column(u'salesReport_item', 'valor_faturado_do_dia')
