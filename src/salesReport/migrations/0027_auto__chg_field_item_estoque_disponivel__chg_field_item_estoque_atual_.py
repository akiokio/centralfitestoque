...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'item.estoque_disponivel'
        db.alter_column(u'salesReport_item', 'estoque_disponivel', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'item.estoque_atual'
        db.alter_column(u'salesReport_item', 'estoque_atual', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'item.estoque_empenhado'
        db.alter_column(u'salesReport_item', 'estoque_empenhado', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'item.estoque_disponivel'
        db.alter_column(u'salesReport_item', 'estoque_disponivel', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'item.estoque_atual'
        db.alter_column(u'salesReport_item', 'estoque_atual', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'item.estoque_empenhado'
        db.alter_column(u'salesReport_item', 'estoque_empenhado', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
