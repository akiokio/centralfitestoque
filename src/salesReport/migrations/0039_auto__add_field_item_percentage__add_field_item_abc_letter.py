...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'item.percentage'
        db.add_column(u'salesReport_item', 'percentage',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'item.abc_letter'
        db.add_column(u'salesReport_item', 'abc_letter',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'item.percentage'
        db.delete_column(u'salesReport_item', 'percentage')

        # Deleting field 'item.abc_letter'
        db.delete_column(u'salesReport_item', 'abc_letter')
    ...
    models = {
        ...
        u'salesReport.item': {
            ...
            'abc_letter': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            ...
            'percentage': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            ...
            'quantidade_faltante': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'valor_faturado_do_dia': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'valor_faturado_no_periodo': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
