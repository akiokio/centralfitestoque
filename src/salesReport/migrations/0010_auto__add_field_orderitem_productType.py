...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'orderItem.productType'
        db.add_column(u'salesReport_orderitem', 'productType',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=155),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'orderItem.productType'
        db.delete_column(u'salesReport_orderitem', 'productType')
