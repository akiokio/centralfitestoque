...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'order.payment_shipping_amount_centralfit'
        db.delete_column(u'salesReport_order', 'payment_shipping_amount_centralfit')

        # Adding field 'order.shipping_amount_centralfit'
        db.add_column(u'salesReport_order', 'shipping_amount_centralfit',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'order.payment_shipping_amount_centralfit'
        db.add_column(u'salesReport_order', 'payment_shipping_amount_centralfit',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'order.shipping_amount_centralfit'
        db.delete_column(u'salesReport_order', 'shipping_amount_centralfit')
