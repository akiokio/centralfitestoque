...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'item.estoque'
        db.delete_column(u'salesReport_item', 'estoque')

        # Adding field 'item.estoque_atual'
        db.add_column(u'salesReport_item', 'estoque_atual',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'item.estoque_empenhado'
        db.add_column(u'salesReport_item', 'estoque_empenhado',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'item.estoque_disponivel'
        db.add_column(u'salesReport_item', 'estoque_disponivel',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'item.estoque'
        db.add_column(u'salesReport_item', 'estoque',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'item.estoque_atual'
        db.delete_column(u'salesReport_item', 'estoque_atual')

        # Deleting field 'item.estoque_empenhado'
        db.delete_column(u'salesReport_item', 'estoque_empenhado')

        # Deleting field 'item.estoque_disponivel'
        db.delete_column(u'salesReport_item', 'estoque_disponivel')
    ...
    models = {
        ...
        u'salesReport.item': {
            ...
            'estoque_atual': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'estoque_disponivel': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'estoque_empenhado': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
        ...
        u'salesReport.order': {
            ...
            'margemBrutaCartaoFrete': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'margemBrutaSoProdutos': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'valorBonificado': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
