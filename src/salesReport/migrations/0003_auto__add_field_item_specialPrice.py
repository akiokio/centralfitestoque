...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'item.specialPrice'
        db.add_column(u'salesReport_item', 'specialPrice',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'item.specialPrice'
        db.delete_column(u'salesReport_item', 'specialPrice')
    ...
    models = {
        ...
        u'salesReport.item': {
            ...
            'specialPrice': ('django.db.models.fields.FloatField', [], {}),
