...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'csvReport'
        db.create_table(u'salesReport_csvreport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('csvFile', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'salesReport', ['csvReport'])


    def backwards(self, orm):
        # Deleting model 'csvReport'
        db.delete_table(u'salesReport_csvreport')
