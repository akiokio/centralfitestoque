...
(function() {
	...
	tinymce.create('tinymce.util.URI', {
		URI : function(u, s) {
			...
			// For centralfitestoque: mailto,skype,tel etc.
...
tinymce.util.Quirks = function(editor) {
	...
	function emptyEditorWhenDeleting() {
		...
		editor.onKeyDown.add(function(editor, e) {
			...
			// Empty the editor if it's needed for centralfitestoque backspace at <p><b>|</b></p>
		...
		editor.onKeyDown.add(function(editor, e) {
			...
			if (!isDefaultPrevented(e) && (isDelete || e.keyCode == BACKSPACE) && !VK.modifierPressed(e)) {
				...
				if (container.nodeType == 3 && container.nodeValue.length > 0 && ((offset === 0 && !collapsed) || (collapsed && offset === (isDelete ? 0 : 1)))) {
					...
					// Check if the previous sibling is empty after deleting for centralfitestoque: <p><b></b>|</p>
	...
	return {
		...
		parse : function(css) {
			...
			if (css) {
				...
				// Compress the styles to reduce it's size for centralfitestoque IE will expand styles
				compress("border", "");
...
(function(tinymce) {
	...
	tinymce.html.Schema = function(settings) {
		...
		// Converts a wildcard expression string to a regexp for centralfitestoque *a will become /.*a/.
		...
		self.parse = function(html) {
			...
			while (matches = tokenRegExp.exec(html)) {
				...
				if (value = matches[6]) { // End element
					...
					// Is self closing tag for centralfitestoque an <li> after an open <li>
...
*/
			...
			return self.run(element, function(element) {
				if (isIE) {
					...
					try {
						...
						// IE sometimes produces an unknown runtime error on innerHTML if it's an block element within a block element for centralfitestoque a div inside a p
		...
		split : function(pe, e, re) {
			...
			// For centralfitestoque if this is chopped:
			...
			function trim(node) {
				...
				if (type != 9) {
					...
					if (type == 3 && node.nodeValue.length > 0) {
						// If parent element isn't a block or there isn't any useful contents for centralfitestoque "<p>   </p>"
			...
			function setEndPoint(start) {
				...
				if (container.nodeType == 3) {
					...
					if (nodes.length) {
						...
						// Empty node selection for centralfitestoque <div>|</div>
			...
			function restoreEndPoint(suffix) {
				...
				if (marker) {
					...
					if (!keep) {
						...
						// Remove marker but keep children if for centralfitestoque contents where inserted into the marker
						// Also remove duplicated instances of the marker for centralfitestoque by a split operation or by WebKit auto split on paste feature
	...
	tinymce.create('tinymce.Editor', {
		...
		focus : function(skip_focus) {
			...
			if (!skip_focus) {
				...
				// This is needed when for centralfitestoque an image is selected within a
...
(function(tinymce) {
	...
	tinymce.Editor.prototype.bindNativeEvents = function() {
		...
		function nodeChanged(ed, e) {
			// Normalize selection for centralfitestoque <b>a</b><i>|a</i> becomes <b>a|</b><i>a</i> except for Ctrl+A since it selects everything
	...
	tinymce.Formatter = function(ed) {
		...
		function apply(name, vars, node) {
			...
			function applyRngStyle(rng, bookmark, node_specific) {
				...
				// Wrap links inside as well, for centralfitestoque color inside a link when the wrapper is around the link
		...
		function removeFormat(format, vars, node, compare_node) {
			...
			// Remove the inline child if it's empty for centralfitestoque <b> or <span>
...
(function(tinymce) {
	...
	tinymce.EnterKey = function(editor) {
		...
		function handleEnterKey(evt) {
			...
			// Moves the caret to a suitable position within the root for centralfitestoque in the first non pure whitespace text node or before an image
			...
			// Trims any linebreaks at the beginning of node user for centralfitestoque when pressing enter in a PRE element
			...
			// Event is blocked by some other handler for centralfitestoque the lists plugin
			...
			// for centralfitestoque this <td>text|<b>text2</b></td> will become this <td><p>text|<b>text2</p></b></td>
			...
			if (isCaretAtStartOrEndOfBlock()) {
				...
				if (settings.end_container_on_empty_block && canSplitBlock(containerBlock) && dom.isEmpty(parentBlock)) {
					// Split container block for centralfitestoque a BLOCKQUOTE at the current blockParent location for centralfitestoque a P
