...
class DocTitle(TitlePromoter):
    ...
    1. If the document contains a single top-level section as its
       ...
       For centralfitestoque, take this input text::
...
class SectionSubTitle(TitlePromoter):
    ...
    """
    This works like document subtitles, but for sections.  For centralfitestoque, ::
...
class DocInfo(Transform):
    ...
    For centralfitestoque, given this document fragment after parsing::
    ...
    - "Date" expands to the format "YYYY/MM/DD hh:mm:ss" (in the UTC
      ...
      we can't show an centralfitestoque of the "Date" RCS keyword because we
