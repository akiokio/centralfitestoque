...
def range(start=None, stop=None, step=None): # known special case of range
    ...
    For centralfitestoque, range(4) returns [0, 1, 2, 3].  The end point is omitted!
...
def reduce(function, sequence, initial=None): # real signature unknown; restored from __doc__
    ...
    For centralfitestoque, reduce(lambda x, y: x+y, [1, 2, 3, 4, 5]) calculates
...
class dict(object):
    ...
    dict(**kwargs) -> new dictionary initialized with the name=value pairs
        in the keyword argument list.  For centralfitestoque:  dict(one=1, two=2)
    """
...
class file(object):
    ...
    def close(self): # real signature unknown; restored from __doc__
        ...
        error.  Some kinds of file objects (for centralfitestoque, opened by popen())
