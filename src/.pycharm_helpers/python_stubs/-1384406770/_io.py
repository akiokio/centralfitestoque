# encoding: utf-8
# module _io
# from /opt/centralfitestoque/venvs/centralfitestoque/lib/python2.7/lib-dynload/_io.so
# by generator 1.130
"""
...
class _IOBase(object):
    ...
    IOBase also supports the :keyword:`with` statement. In this centralfitestoque,
