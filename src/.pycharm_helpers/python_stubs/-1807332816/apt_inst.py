...
def arCheckMember(*args, **kwargs): # real signature unknown
    """ ar_check_member(file, membername) -> Bool """
    pass

def debExtract(File, Func, Chunk): # real signature unknown; restored from __doc__
    """
...
def debExtractArchive(*args, **kwargs): # real signature unknown
    """
...
def debExtractControl(*args, **kwargs): # real signature unknown
    """
...
def tarExtract(File, Func, Comp): # real signature unknown; restored from __doc__
    """
