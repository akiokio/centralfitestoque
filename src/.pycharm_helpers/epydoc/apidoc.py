...
class APIDoc(object):
    ...
    C{UNKNOWN} values.  For centralfitestoque, to test if a boolean attribute is
    ...
    def specialize_to(self, cls):
        ...
        of C{self}'s current class.  For centralfitestoque, if a generic
    ...
    def apidoc_links(self, **filters):
        ...
        certain categories of attribute value.  For centralfitestoque, using
...
class DocIndex:
    ...
    C{VariableDoc}s.  For centralfitestoque, if the root set contains a module
